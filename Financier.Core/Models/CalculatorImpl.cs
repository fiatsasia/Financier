...
{
    class DecimalCalculator : Financier.ICalculator<decimal>
    {
    ...
    class DoubleCalculator : Financier.ICalculator<double>
    {
    ...
    class FloatCalculator : Financier.ICalculator<float>
    {
